...
UserLoginRespModel logInModelFromJson(String str) =>
    UserLoginRespModel.fromJson(json.decode(str));

String logInModelToJson(UserLoginRespModel data) => json.encode(data.toJson());

class UserLoginRespModel {
  String message;
  String accessToken;
  User user;
  ...
  factory UserLoginRespModel.fromJson(Map<String, dynamic> json) =>
      UserLoginRespModel(
